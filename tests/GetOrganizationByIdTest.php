...
final class GetOrganizationByIdTest extends TestCase
{
    private $sriClient;
    ...
    {
        $organization = $this->sriClient->getOrganizationById($_ENV['TEST_ORGANIZATION_ID']);
        $this->assertEquals($_ENV['TEST_ORGANIZATION_ID'], $organization['id']);
    }
}
